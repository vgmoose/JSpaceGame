...
public class TrigMath
{
	...
	// This tangent function is mostly accurate for -1 < x < 1. It uses the
	// taylor series
	...
	// This absolute value function returns float, rather than the long provided
	// in abs in math.h
	...
	// sauce to allow it to
	// work in every quadrant of the graph: https://en.wikipedia.org/wiki/Atan2
	// It is used to get the angle given an <x, y> vector (such as joystick
	// input)
